...
?>
  ...
  <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-1 main row-padding">
		...
		//Both edit and delete will change the books table only
			echo "<td>
						<form name='submit_program_ID' action='editbookAdmin.php' method='POST'>
				...
				echo "<td>
						<form name='submit_program_ID' action='booksAdmin.php' method='POST'>
						<input type= 'hidden' name ='book_id' value ='".$row['book_id']."'>
