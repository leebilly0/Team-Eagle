...
$donorId = $_GET['donorId'];
 ...
 $deleteQuery = "DELETE FROM donors WHERE donor_id = '$donorId'";
...
if (mysqli_query($DataBaseCon, $deleteQuery)) {
    ...
    //query to execute
   $donorFname= $_SESSION["donorFname"];
 $donorLname= $_SESSION["donorLname"];
 $donorDate=  $_SESSION["donorDate"];
  $donorAmount= $_SESSION["donorAmount"];
      $getData = "SELECT donor_fname,donor_lname,donate_dd,total_amt"
                . " FROM donors WHERE (donor_fname = '$donorFname' or donor_lname='$donorLname' or "
                . "donate_dd = '$donorDate' or total_amt='$donorAmount')";
