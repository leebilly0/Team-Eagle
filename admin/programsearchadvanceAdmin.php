                ...
                <div class="panel-body">
                    ...
                    <form action ="searchresultsAdmin.php" method="POST" class="form-horizontal" >
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="text" name ="programAdmin" class="form-control"  >
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10"> 
                                <input type="text" name ="missionAdmin" class="form-control"  >
                            </div>
                        </div>
                        <div class="form-group "> 
                            <div class="col-sm-offset-2 col-sm-10">
                                <button name="reset" type="reset" class="btn btn-default ">Clear</button>
                                <button type="submit" name ="ProgramAdvancedSearchAdmin" class="btn btn-primary">Search</button>
                            </div>
                        </div>
                    </form> </div>
            </div>
