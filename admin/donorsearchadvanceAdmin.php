                ...
                <div class="panel-body">
                    ...
                    <form action ="searchresultsAdmin.php" method="POST" class="form-horizontal" >
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="text" name ="donorFirstNameAdmin" class="form-control"  >
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="control-label col-sm-2" >Donor Last Name:</label>
                            <div class="col-sm-10">
                                <input type="text" name ="donorLastNameAdmin" class="form-control"  >
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10"> 
                                <input type="number" step="any" name ="totalAmountAdmin" class="form-control"  >
                            </div>
                        </div>
                        <div class="form-group "> 
                            <div class="col-sm-offset-2 col-sm-10">
                                <button name="reset" type="reset" class="btn btn-default ">Clear</button>
                                <button type="submit" name ="DonorAdvancedSearchAdmin" class="btn btn-primary">Search</button>
                            </div>
                        </div>
                    </form> </div>
            </div>
