...
if (mysqli_query($DataBaseCon, $deleteQuery)) {
    ...
    //query to execute
    $bookKeywowrd = $_SESSION["bookKeyword"];
    $getData = "SELECT book_id,book_title,author_fname,author_lname,genre,year_ofpub,isbn,language,cost"
            . " FROM books WHERE book_title LIKE CONCAT('%', '$bookKeywowrd', '%') "
            . "OR author_fname LIKE CONCAT('%', '$bookKeywowrd', '%')  OR author_lname LIKE CONCAT('%', '$bookKeywowrd', '%') OR genre LIKE CONCAT('%', '$bookKeywowrd', '%')"
            . "OR year_ofpub LIKE CONCAT('%', '$bookKeywowrd', '%') OR isbn LIKE CONCAT('%', '$bookKeywowrd', '%') OR language LIKE CONCAT('%', '$bookKeywowrd', '%') OR cost LIKE CONCAT('%', '$bookKeywowrd', '%')";
